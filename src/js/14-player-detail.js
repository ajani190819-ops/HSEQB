...
<div class="pd-stat-chips"><span class="pd-chip" style="background:color-mix(in srgb,var(--pt-tossup) 10%,transparent);color:var(--pt-tossup);border:1px solid color-mix(in srgb,var(--pt-tossup) 30%,transparent);">${player.tossupsCorrect + player.powers} Correct</span><span class="pd-chip" style="background:color-mix(in srgb,var(--pt-power) 10%,transparent);color:var(--pt-power);border:1px solid color-mix(in srgb,var(--pt-power) 30%,transparent);">⚡︎ ${player.powers} Power${player.powers !== 1 ? 's' : ''}</span><span class="pd-chip" style="background:color-mix(in srgb,var(--pt-neg) 10%,transparent);color:var(--pt-neg);border:1px solid color-mix(in srgb,var(--pt-neg) 30%,transparent);">− ${player.negs} Neg${player.negs !== 1 ? 's' : ''}</span><span class="pd-chip" style="background:color-mix(in srgb,var(--pt-miss) 10%,transparent);color:var(--pt-miss);border:1px solid color-mix(in srgb,var(--pt-miss) 30%,transparent);">${player.misses} Miss${player.misses !== 1 ? 'es' : ''}</span><span class="pd-chip" style="background:color-mix(in srgb,var(--primary) 10%,transparent);color:var(--primary);">${player.tHeard || 0} TU Heard</span></div>
