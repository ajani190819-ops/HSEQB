...
Write-Host '   KEYBOARD LIGHTING - DIAGNOSTIC  (check v15)' -ForegroundColor Cyan
Write-Host '  ===============================================================' -ForegroundColor Cyan
Log '  ==============================================================='
Log '   KEYBOARD LIGHTING - DIAGNOSTIC  (check v15)'
Log '  ==============================================================='
...
# ---------------------------------------------------------------- 2. files
Head '2. Script files'
$want = @('Aura-Background.ps1','Tray.ps1','ui_controls.cs.txt','app.ico','Install.ps1','Install.bat','Check.ps1','Check.bat','Update.ps1','Update.bat','MyEffect.ps1','README.md')
foreach ($f in $want) {
    $p = Join-Path $here $f
    if (Test-Path $p) {
        $i = Get-Item $p
